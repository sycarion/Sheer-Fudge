...
A typical combat encounter is a clash between two sides, a flurry of weapon swings, feints, parries, footwork, and spellcasting. The game organizes the chaos of combat into a cycle of rounds and actions. A **round** represents about 1 minute in the game world. There are ten rounds in a **segment**. During a round, each participant in a battle takes one or more **actions**. The order of actions is determined at the beginning of each round, when everyone rolls initiative. Once everyone has taken their actions, the fight continues to the next round if neither side has defeated the other.
...
># Order of Combat
>1.	** Determine Surprise.** The GM determines whether anyone involved in the combat encounter is surprised.
>2.	** Roll Initiative.** All combtants roll a d10 and apply speed factor modifiers. The GM rolls once for all NPC combatants.
>3.	** State Intent.** The GM asks each player to state what their character intends to do.
>4.	**Take turns.** From low to high, each participant takes their turn. If two or more combatants share the same result, their actions occur at the same time.
>5.	**Changing Actions** If a combatant changes their action, they will take their action last.
>6.	** Resolve extra attacks** When all combatants have taken an action, any extra actions are resolved in initiative order (no reroll).
>7. **Begin the next round.** When everyone involved in the combat has had completed their actions, the round ends. Repeat from Step 2 until the combat stops.

## Surprise

<!-->A band of adventurers sneaks up on a bandit camp, springing from the trees to attack them. A gelatinous cube glides down a dungeon passage, unnoticed by the adventurers until the cube engulfs one of them. In these situations, one side of the battle gains surprise over the other.

The GM determines who might be surprised. If anyone in combat can be surprised, those affected roll a d10 and apply modifers. Results of 3 or less mean that the individual combatant is surprised.

Surprised combatants cannot take any actions until the round ends. A member of a group can be surprised even if the other members aren't.-->

A band of adventurers sneaks up on a bandit camp, springing from the trees to attack them. A gelatinous cube glides down a dungeon passage, unnoticed by the adventurers until the cube engulfs one of them. In these situations, one side of the battle gains surprise over the other.

The GM determines who might be surprised. If needed, characters roll a d10 and apply modifiers. The GM rolls for the other side. Any character or monster that doesn't notice a threat is surprised at the start of the encounter.

If you're surprised, you can't move or take any actions on your first round of the combat until that round ends. A member of a group can be surprised even if the other members aren't.

## Initiative

<!-->Initiative determines the order of actions during combat. When combat starts, every participant makes a Dexterity check to determine their place in the initiative order. The GM makes one roll for an entire group of identical creatures, so each member of the group acts at the same time.
...
On oyur turn, you can **move** a distance up to your speed and **take one action**. You decide whether to move first or take your action first. Your speed- sometimes called your walking speed-is noted on your character sheet.
